...
-- VIOLATION DATA
INSERT INTO operations.cardholder_data 
(customer_id, cardholder_name, card_number, card_number_masked, expiry_date, cvv) VALUES
-- VIOLATION 2 & 3: Clear text PAN + CVV stored
(1001, 'John Smith', '4532015112830366', '453201******0366', '12/2026', '123'),
(1002, 'Jane Doe', '5425233430109903', '542523******9903', '03/2027', '456'),
(1003, 'Bob Wilson', '4916338506082832', '491633******2832', '09/2025', '789'),

-- COMPLIANT: Masked PAN, no CVV
(2001, 'Alice Johnson', '************4589', '************4589', '06/2027', NULL),
(2002, 'Charlie Brown', '************7823', '************7823', '11/2026', NULL);
...
INSERT INTO operations.transactions 
(card_id, merchant_id, amount, full_pan, sad_data, authorization_code, response_code, processed_by_user) VALUES
-- VIOLATION 2: Full PAN and SAD stored after authorization
(1, 101, 150.00, '4532015112830366', 'CVV=123;PIN_BLOCK=A1B2C3D4', 'AUTH001', '00', 'user_sales'),
(2, 101, 275.50, '5425233430109903', 'CVV=456;TRACK2=5425233430109903D2703', 'AUTH002', '00', 'user_sales'),
(3, 102, 89.99, '4916338506082832', 'CVV=789', 'AUTH003', '00', 'user_support'),

-- COMPLIANT: No clear PAN, no SAD
(4, 101, 200.00, NULL, NULL, 'AUTH004', '00', 'user_sales'),
(5, 102, 350.00, NULL, NULL, 'AUTH005', '00', 'user_sales');
...
(username, email, department, job_title, can_view_full_pan, requires_full_pan, access_approved) VALUES
-- VIOLATION 1: Users with full PAN access without business need
('user_sales', 'sales@company.com', 'Sales', 'Sales Representative', TRUE, FALSE, FALSE),
('user_support', 'support@company.com', 'Support', 'Customer Support', TRUE, FALSE, FALSE),
('user_marketing', 'marketing@company.com', 'Marketing', 'Marketing Analyst', TRUE, FALSE, FALSE),

-- COMPLIANT: Users with proper access control
('user_fraud', 'fraud@company.com', 'Fraud', 'Fraud Analyst', TRUE, TRUE, TRUE),
('user_cashier', 'cashier@company.com', 'Retail', 'Cashier', FALSE, FALSE, TRUE);
...
(event_timestamp, user_id, event_type, event_description, data_accessed, full_pan_viewed, card_id, source_ip) VALUES
-- VIOLATION 1: Unrestricted access to full PAN by users without business need
('2026-01-15 10:30:00', 'user_sales', 'DATA_ACCESS', 'Viewed full cardholder data', 'cardholder_data', TRUE, 1, '192.168.1.10'),
('2026-01-15 11:00:00', 'user_support', 'DATA_ACCESS', 'Accessed transaction details with full PAN', 'transactions', TRUE, 2, '192.168.1.11'),
('2026-01-15 14:20:00', 'user_marketing', 'DATA_ACCESS', 'Exported customer payment data', 'cardholder_data', TRUE, 3, '192.168.1.12'),

-- COMPLIANT: Authorized access with business justification
('2026-01-16 09:00:00', 'user_fraud', 'DATA_ACCESS', 'Fraud investigation - Case #12345', 'cardholder_data', TRUE, 1, '192.168.1.50'),
('2026-01-16 10:00:00', 'user_cashier', 'DATA_ACCESS', 'Processed payment - masked PAN only', 'cardholder_data', FALSE, 4, '192.168.1.20');
